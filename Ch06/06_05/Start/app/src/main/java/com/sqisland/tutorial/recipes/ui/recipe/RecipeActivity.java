...
public class RecipeActivity extends AppCompatActivity implements RecipeContract.View {
    ...
    public void setTitle(String title) {
        ...
        // Update the title using the parameter passed into the method
    ...
    public void setDescription(String description) {
        ...
        // Update the description using the parameter passed into the method
    ...
    public void setFavorite(boolean favorite) {
        ...
        // Update the favorite using the parameter passed into the method
